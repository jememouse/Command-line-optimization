...
() {
 ...
 typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    # ========================= 右侧提示符元素 =========================
    status                  # 上一条命令的退出状态
    command_execution_time  # 上一条命令的执行时间
  ...
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='%F{15}conda:%f ${P9K_CONTENT}'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_SHOW_WITH_PYENV=true
...
typeset -g POWERLEVEL9K_INSTANT_PROMPT=quiet  # Hot reload gives you a live preview of changes in ~/.p10k.zsh. You can edit the file,
  ...
  # You can enable it if you really want it:
  #
